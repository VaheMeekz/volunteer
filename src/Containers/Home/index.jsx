...
const Home = () => {
    ...
    const newsdata = useSelector((state) => state.newsReducer.news)?.products;
        ...
        <>
            ...
            <section>
                <Container>
                    ...
                    <Row>
                        {
                            newsdata && newsdata?.slice(0, 4).map(i => {
                                return (
                                    <Col sm={12} md={6} lg={3} onClick={()=>navigate(`/detail/${i.id}`)}>
                                        <div className={styles.news_block}>
                                            ...
                                            <p className={styles.news_text}>
                                                {localStorage.getItem("lang") == "am "
                                                    ? i.descriptionHy.substr(0, 50)
                                                    : i.descriptionEn.substr(0, 50)}...
                                            </p>
                                        </div>
                                    </Col>
                                )
